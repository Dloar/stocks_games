...
def load_yf_data() -> tuple:
    ...
    stocks_data_f = {name: pd.DataFrame() for name in list_of_stocks}
    for symbol in list_of_stocks:
        ...
        tickerDf = tickerData.history(period='1d', start='2018-01-01', end=today)
        ...
        stocks_data_f[symbol] = tickerDf

    return stocks_data_f, stocks_data
